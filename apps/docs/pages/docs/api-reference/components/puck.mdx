...
Modify the height of Puck when using the standard layout. Defaults to `100dvh`.
...
Use a full screen mode for the Puck canvas, with floating viewport switcher. **This param is experimental.**
