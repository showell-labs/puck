...
| [`newItemPosition`](#newitemposition) | `newItemPosition: "end"`     | `"start" \| "end"` | -        |
...
Force where newly inserted components are placed in this slot, regardless of cursor position while dragging.

Options:

- `"start"` - insert at the beginning of the slot
- `"end"` - insert at the end of the slot
