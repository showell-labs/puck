...
| [`maxHeight`](#maxheight)                      | `maxHeight: 312`                           | Number \| String | -        |
...
Set the maximum height for the field input. Defaults to `256`.
        ...
        renderMenu: ({ children }) => (
          <RichTextMenu>
            ...
            <RichTextMenu.Group>
              ...
              <RichTextMenu.Control icon={<Highlighter />} />
            </RichTextMenu.Group>
          </RichTextMenu>
        ),
      },
...
| [`editor`](#editor)           | `<div />` | Editor      |
| [`editorState`](#editorstate) | `<div />` | EditorState |
